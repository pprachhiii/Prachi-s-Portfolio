...
import { Code, Terminal, Globe, Database, Zap, GitBranch, Layers, Star } from 'lucide-react';
  ...
  return (
    ...
    >
      <div className="text-center mb-16 relative z-10">
        <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">Tools of the Trade</h2>
      ...
      <div
        className={`columns-1 md:columns-2 lg:columns-3 gap-10 max-w-7xl mx-auto transition-all duration-1000 ${
